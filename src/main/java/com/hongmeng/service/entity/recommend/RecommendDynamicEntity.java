...
@Entity
@Table(name = "recommend_dynamic")
public class RecommendDynamicEntity extends BaseEntity {
	...
	public RecommendDynamicEntity() {
		// TODO Auto-generated constructor stub
	}

	public RecommendDynamicEntity(CompanyEntity company, String title, String source, String linkPath) {
		super();
