...
@Entity
@Table(name = "manufacture_case")
public class ManufactureCaseEntity extends BaseEntity {
	...
	public ManufactureCaseEntity() {
		// TODO Auto-generated constructor stub
	}

	public ManufactureCaseEntity(CompanyEntity company, String title, String source, String linkPath) {
		super();
