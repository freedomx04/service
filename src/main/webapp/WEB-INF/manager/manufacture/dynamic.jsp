...
<script class='template ManufactureDynamic' type='text/x-jquery-tmpl'>
	<div class='row'>
		<div class='col-lg-12'>
		...
		<div class='col-lg-12'>
			<div class='module-list'>
				...
				<div class='list-table' style='font-size: 12px;'>
					<table class='table table-hover hm-table' id='manufacture-dynamic-table'>
						<tr><td>
...
<script class='template ManufactureDynamicDialog' type='text/x-jquery-tmpl'>
	<div class="modal-dialog" style="width: 850px;">
   		<div class="modal-content">
      		...
      		<div class="modal-body">
       			<form class="form-horizontal" role="form" id="manufacture-dynamic-form">
...
<script class='template ManufactureDynamicList' type='text/x-jquery-tmpl'>
	<thead>
		<tr>	
	...
	Klass.prototype = Object.create(Object.prototype, {
		...
		init: {
			value: function($tar) {
				...
				.on('click', '.btn-dynamic-edit', function() {
					...
					$.ajax({
						url: 'manufacture/dynamic/detail',
						type: 'POST',
						data: {
							dynamicId: dynamicId
						},
				...
				.on('click', '.btn-dynamic-delete', function() {
					...
					.on("click", ".btn-confirm", function() {
						$.ajax({
							url: 'manufacture/dynamic/delete',
							type: 'POST',
							data: {
		...
		draw: {
			value: function(companyId, dynamics) {
				...
				self.$tar.find('#manufacture-dynamic-table').html(
					self.$tempListTar.doT({
						data: dynamics
					})
				);
				self.table = $k.util.dataTable(self.$tar.find('#manufacture-dynamic-table'), {
					'order': [[ 3, 'desc' ]]
				}); 
		...
		load: {
			value: function() {
				...
				$.ajax({
					url: 'manufacture/dynamic/listByCompanyId',
					type: 'POST',
					data: {
						companyId: self.companyId
					},
