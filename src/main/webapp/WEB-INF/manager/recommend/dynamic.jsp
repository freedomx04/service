...
<script class='template RecommendDynamic' type='text/x-jquery-tmpl'>
	<div class='row'>
		<div class='col-lg-12'>
		...
		<div class='col-lg-12'>
			<div class='module-list'>
				...
				<div class='list-table' style='font-size: 12px;'>
					<table class='table table-hover hm-table' id='recommend-dynamic-table'>
						<tr>
							<td>
...
<script class='template RecommendDynamicDialog' type='text/x-jquery-tmpl'>
	...
	Klass.prototype = Object.create(Object.prototype, {
		...
		draw: {
			value: function(companyId, dynamics) {
				...
				self.$tar.find('#recommend-dynamic-table').html(
					self.$tempListTar.doT({
						data: dynamics
					})
				);
				self.table = $k.util.dataTable(self.$tar.find('#recommend-dynamic-table'), {
					'order': [[ 3, 'desc' ]]
				}); 
		...
		load: {
			value: function() {
				...
				$.ajax({
					url: 'recommend/dynamic/listByCompanyId',
					type: 'POST',
					data: {
						companyId: self.companyId
					},
